...
void Misc::Chatspam() {
	...
	std::vector<std::string> chatspams = {
		"killaura | Best free cheat for CS:GO",
		"I use Killaura - FREE LEGIT CS:GO DLC",
		"get owned by killaura",
		"Join us! | yougame.biz/threads/129045/",
	};
...
void Misc::Namespam() {
	...
	*(int*)((DWORD)&Name->m_fnChangeCallbacks + 0xC) = 0;
	...
	if (Name) {
		if (steal) Name->SetValue("killaura");		
		else Name->SetValue("killaura ");
		steal = !steal;
	}
}
...
void Misc::Clantag() {
	...
	if (int(g_GlobalVars->curtime * 2.9) != prevtime) {
		if (prevval != int(g_GlobalVars->curtime * 2.9) % 30) {
			...
			{
			case 29: { Utils::SetClantag("[ killaura ]");  break; }
			case 28: { Utils::SetClantag("[ killaur ]");  break; }
			case 27: { Utils::SetClantag("[ killau ]");  break; }
			case 26: { Utils::SetClantag("[ killa ]");  break; }
			case 25: { Utils::SetClantag("[ kill ]");  break; }
			case 24: { Utils::SetClantag("[ kil ]");  break; }
			case 23: { Utils::SetClantag("[ ki ]");  break; }
			case 22: { Utils::SetClantag("[ k ]");  break; }
			case 21: { Utils::SetClantag("[ ki ]");  break; }
			case 20: { Utils::SetClantag("[ kil ]");  break; }
			case 19: { Utils::SetClantag("[ kill ]");  break; }
			case 18: { Utils::SetClantag("[ killa ]");  break; }
			case 17: { Utils::SetClantag("[ killau ]");  break; }
			case 16: { Utils::SetClantag("[ killaur ]");  break; }
			case 15: { Utils::SetClantag("[ killaura ]");  break; }
			case 14: { Utils::SetClantag("[ killaur ]");  break; }
			case 13: { Utils::SetClantag("[ killau ]");  break; }
			case 12: { Utils::SetClantag("[ killa ]");  break; }
			case 11: { Utils::SetClantag("[ kill ]");  break; }
			case 10: { Utils::SetClantag("[ kil ]");  break; }
			case 9: { Utils::SetClantag("[ ki ]");  break; }
			case 8: { Utils::SetClantag("[ k ]");  break; }
			case 7: { Utils::SetClantag("[ ki ]");  break; }
			case 6: { Utils::SetClantag("[ kil ]");  break; }
			case 5: { Utils::SetClantag("[ kill ]");  break; }
			case 4: { Utils::SetClantag("[ killa ]");  break; }
			case 3: { Utils::SetClantag("[ killau ]");  break; }
			case 2: { Utils::SetClantag("[ killaur ]");  break; }
